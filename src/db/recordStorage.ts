...
const recordSchema = z.object({
  ...
  geometry: z.object({ kind: z.literal('POINT'), datum: z.literal('WGS84'), longitude: z.number().min(-180).max(180), latitude: z.number().min(-90).max(90), horizontalUncertaintyM: z.number().nonnegative().optional() }).strict().optional(),
