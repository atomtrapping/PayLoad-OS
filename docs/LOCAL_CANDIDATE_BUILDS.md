...
NotationsOS can now assemble an explicit set of locally normalized Caravan Carrier candidates into a deterministic, time-bounded candidate build. This is a shared internal production rail for Caravan. It is not canonical corpus admission, a released information product or a customer API.
