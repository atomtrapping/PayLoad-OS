...
| 10 | `shfe-stocks` | SHFE copper weekly warehouse stocks, Chinese delivery warehouses, report week ending 2026-08-28; at most 25 warehouse/model rows with native units and date. | [Official market/data site][shfe-data] exists. Exact weekly-stock endpoint and applicable reuse terms remain unqualified. This is a review blocker, not a claim that all SHFE statistics require the same license as a trading feed. |
